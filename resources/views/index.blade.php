        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <div class="carousel-caption p-5">
                    ...
                    <p class="carousel-paragraph">Image created by <i>RadiasaTutorial Rti</i> from <a
                            href="http://vecteezy.com">Vecteezy</a></p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption p-5">
                    ...
                    <p class="carousel-paragraph">Image created by <i>flatart</i> from <a href="http://vecteezy.com">Vecteezy</a>
                    </p>
                </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption p-5">
                    ...
                    <p class="carousel-paragraph">Image created by <i>studiogstock</i> from <a
                            href="http://vecteezy.com">Vecteezy</a></p>
                </div>
            </div>
            <div class="carousel-item">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption p-5">
                    ...
                    <p>Update and view company details, including contact info, address, company name, and relevant
                        data.</p>
                    <p class="carousel-paragraph">Image created by <i>husein signart</i> from <a
                            href="http://vecteezy.com">Vecteezy</a></p>
                </div>
            </div>
            <div class="carousel-item">
                ...
                <div class="carousel-caption p-5">
                    ...
                    <p class="carousel-paragraph">Image created by <i>rizal.medanguide from</i> <a
                            href="http://vecteezy.com">Vecteezy</a></p>
                </div>
            </div>
        </div>
